    ...
    <div id="item">
        <div class="crumb-wrap">
            <ul class="sui-breadcrumb">
                <li><a href="#">${itemCat_1}</a></li>
                <li><a href="#">${itemCat_2}</a></li>
                <li><a href="#">${itemCat_3}</a></li>
            </ul>
        </div>
        <!--product-info-->
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom">
                            <#if (itemImageList?size>0)>
                                <img jqimg="${itemImageList[0].url}" src="${itemImageList[0].url}" width="400px"
                                     height="400px"/>
                            </#if>
                        </span>
                    </div>
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        <#list specificationItemList as item>
                            <dl>
                                <dt>
                                    <div class="fl title">
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            <ul class="goods-intro unstyled">
                                <#list customAttributeItemList as item>
                                <#--如果扩展属性为空则不显示此条数据 -->
                                    <#if item.value??>
